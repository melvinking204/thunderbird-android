...
class HtmlSettingsProvider(private val themeManager: ThemeManager? = null) {
    fun createForMessageView(useDarkTheme: Boolean? = null) = HtmlSettings(
        useDarkMode = useDarkTheme ?: (themeManager!!.messageViewTheme == Theme.DARK),
