...
class AccountPreferenceSerializer(
    ...
    fun loadAccount(account: Account, storage: Storage) {
        ...
        with(account) {
            ...
            isDeleteMessageAfterDownload = storage.getBoolean("$accountUuid.deleteMessageAfterDownload", false)
    ...
    fun save(editor: StorageEditor, storage: Storage, account: Account) {
        ...
        with(account) {
            ...
            editor.putBoolean("$accountUuid.deleteMessageAfterDownload", isDeleteMessageAfterDownload)
    ...
    fun delete(editor: StorageEditor, storage: Storage, account: Account) {
        ...
        editor.remove("$accountUuid.deleteMessageAfterDownload")
